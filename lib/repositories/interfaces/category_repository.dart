/// Abstract repository contract defining category operations interface.
///
/// Defines the contract for category data operations following the Repository pattern.
...
/// The contract enforces consistent error handling across all category operations.
...
abstract class CategoryRepository {
  ...
  Future<Either<DatabaseFailure, List<CategoryEntity>>> getAll();

  Future<Either<DatabaseFailure, CategoryEntity?>> getById(String id);
